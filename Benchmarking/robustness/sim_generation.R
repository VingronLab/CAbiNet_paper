...
maindir <- paste0("../../Data/sim_data/raw/robustness/", dataset, "/")
...
props <- c(
    0.12, 0.04, 0.07, 0.09, 0.02,
    0.03, 0.03, 0.05, 0.06, 0.07,
    0.07, 0.04, 0.03, 0.05, 0.03,
    0.05, 0.06, 0.03, 0.03, 0.03
)

# Uncomment to add more difficulty levels.
difficulty <- list(
    # list("de.prob" = 0.1, "de.facLoc" = 1.5, "de.facScale" = 1.5),
    list("de.prob" = 0.1, "de.facLoc" = 0.75, "de.facScale" = 0.75),
    # list("de.prob" = 0.06, "de.facLoc" = 0.75, "de.facScale" = 0.75)
)

for (d in seq_len(length(difficulty))) {
    for (ngene in ngenes) {
        for (ncell in ncells) {
            ...
            sim <- splatSimulate(params,
                ...
                group.prob = props,
                method = "groups",
                de.prob = difficulty[[d]]$de.prob,
                de.facLoc = difficulty[[d]]$de.facLoc,
                de.facScale = difficulty[[d]]$de.facScale,
                out.prob = 0.001,
                de.downProb = c(0),
            ...
            name <- paste0(
                ...
                "ncell-", ncell,
                "_ngene-", ngene,
                "_deprob-", difficulty[[d]]$de.prob,
                "_defacLoc-", difficulty[[d]]$de.facLoc,
                "_defacScale-", difficulty[[d]]$de.facScale
            )
