...
reindex = function(bic){
    # stopifnot(identical(unique(gene_clusters(bic)), unique(cell_clusters(bic))))
    ...
    # newbic@gene_clusters = droplevels(newbic@gene_clusters)
