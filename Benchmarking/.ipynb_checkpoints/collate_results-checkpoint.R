...
# Rscript-4.2.1 collate_results.R --name "221114_pbmc3k_splatter_sim_preprocessed" \
#                             --indir "/project/CAclust/CAbiNET_paper/benchmarking/simulated/res/out/pbmc3k/" \
#                             --outdir "/project/CAclust_scripts/CAclust_paper/benchmarking_splatter_sim/collated_results/"

# Rscript-4.2.1 collate_results.R --name "221114_zeisel_splatter_sim_preprocessed" \
#                             --indir "/project/CAclust/CAbiNET_paper/benchmarking/simulated/res/out/zeisel/" \
#                             --outdir "/project/CAclust_scripts/CAclust_paper/benchmarking_splatter_sim/collated_results/"